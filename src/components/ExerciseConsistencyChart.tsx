...
export function ExerciseConsistencyChart({
  ...
  return (
    <div className="space-y-6">
      {/* Period Tabs */}
      <div className="flex rounded-lg bg-solarized-base1/30 p-1">
      ...
      <div className="flex items-center gap-4">
        <div className={`px-3 py-1.5 rounded-full text-sm font-medium border ${patternStyle.bg} ${patternStyle.text} ${patternStyle.border}`}>
          {pattern}
        </div>

        {trend && period === '4months' && (
          <div className={`flex items-center gap-1.5 text-sm font-medium ${trendConfig[trend.direction].color}`}>
